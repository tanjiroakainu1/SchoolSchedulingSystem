...
const variants = {
  primary:
    'bg-gradient-to-r from-primary-600 to-accent-500 text-white hover:from-primary-700 hover:to-accent-600 active:scale-[0.98] shadow-md shadow-primary-600/25 hover:shadow-lg hover:shadow-accent-500/20',
  secondary:
