...
export function DashboardPreview() {
  return (
    <div className="relative mx-auto w-full max-w-lg lg:max-w-none animate-slide-up">
      <div className="absolute -inset-4 bg-gradient-to-r from-primary-500/30 to-indigo-500/30 rounded-[2rem] blur-2xl opacity-60" />
      <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl ring-1 ring-white/20 shadow-2xl overflow-hidden">
        ...
        <div className="flex min-h-[280px] sm:min-h-[320px]">
          ...
          <div className="hidden sm:flex flex-col w-16 lg:w-20 border-r border-white/10 bg-black/10 p-2 gap-2">
            <div className="w-10 h-10 mx-auto rounded-xl bg-gradient-to-br from-primary-500 to-indigo-600 flex items-center justify-center">
          ...
          <div className="flex-1 p-4 sm:p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              {[
                { label: 'Sections', value: '24', color: 'from-blue-500/30 to-blue-600/10' },
                { label: 'Faculty', value: '18', color: 'from-emerald-500/30 to-emerald-600/10' },
                { label: 'Rooms', value: '12', color: 'from-violet-500/30 to-violet-600/10' },
      ...
      <div className="absolute -right-2 sm:-right-4 bottom-8 px-3 py-2 rounded-xl bg-gradient-to-r from-primary-600 to-indigo-600 text-white shadow-xl text-xs font-bold animate-fade-in">
        Scheduly AI ✨
      </div>
    </div>
  );
